...
class ConstantsWindow(QtGui.QMainWindow):
    EDITABLE_PROPERTIES = ['WORLD_HEIGHT', 'WORLD_WIDTH', 'FOOD_TIMER', 'YEAR_CYCLE_COUNT', 'WINTER_FOOD_TIMER',
                           'SUMMER_FOOD_TIMER', 'ANIMAL_MAX_ENERGY', 'ANIMAL_SIZE', 'APPEAR_FOOD_COUNT',
                           'APPEAR_FOOD_SIZE_MAX', 'APPEAR_FOOD_SIZE_MIN', 'EATING_DISTANCE', 'EATING_VALUE',
                           'ENERGY_FOR_BIRTH', 'ENERGY_FOR_EXIST', 'ENERGY_FULLNESS_TO_INCREASE_READINESS_TO_SEX',
                           'FOOD_FROM_MAMMOTH_COUNT', 'FOOD_SIZE_TO_ENERGY_RATIO', 'FOOD_SMELL_SIZE_RATIO',
                           'INITIAL_ANIMAL_COUNT', 'INITIAL_FOOD_COUNT', 'MAMMOTH_BEAT_VALUE', 'MAMMOTH_COUNT',
