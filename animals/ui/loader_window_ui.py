...
class Ui_LoaderWindow(object):
    def setupUi(self, LoaderWindow):
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget2.addItem(item)
        self.gridLayout_2.addWidget(self.listWidget2, 3, 2, 1, 2)
        self.print_latest_button = QtWidgets.QPushButton(self.centralwidget)
        self.print_latest_button.setObjectName("print_latest_button")
        self.gridLayout_2.addWidget(self.print_latest_button, 1, 2, 1, 2)
        self.refresh_button = QtWidgets.QPushButton(self.centralwidget)
        self.refresh_button.setObjectName("refresh_button")
        self.gridLayout_2.addWidget(self.refresh_button, 0, 2, 1, 2)
        self.analyze_button = QtWidgets.QPushButton(self.centralwidget)
        self.analyze_button.setObjectName("analyze_button")
        self.gridLayout_2.addWidget(self.analyze_button, 2, 2, 1, 1)
        self.analyze_all_button = QtWidgets.QPushButton(self.centralwidget)
        self.analyze_all_button.setObjectName("analyze_all_button")
        self.gridLayout_2.addWidget(self.analyze_all_button, 2, 3, 1, 1)
    ...
    def retranslateUi(self, LoaderWindow):
        ...
        self.print_latest_button.setText(_translate("LoaderWindow", "Print latest"))
        self.refresh_button.setText(_translate("LoaderWindow", "Refresh"))
        self.analyze_button.setText(_translate("LoaderWindow", "Analyze"))
        self.analyze_all_button.setText(_translate("LoaderWindow", "Analyze All"))
